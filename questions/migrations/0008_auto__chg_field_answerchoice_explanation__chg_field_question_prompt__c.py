...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'AnswerChoice.explanation'
        db.alter_column('questions_answerchoice', 'explanation', self.gf('django.db.models.fields.CharField')(max_length=240, null=True))

        # Changing field 'Question.prompt'
        db.alter_column('questions_question', 'prompt', self.gf('django.db.models.fields.CharField')(max_length=240, null=True))

        # Changing field 'Question.code'
        db.alter_column('questions_question', 'code', self.gf('django.db.models.fields.TextField')(null=True))

        # Changing field 'Question.comment'
        db.alter_column('questions_question', 'comment', self.gf('django.db.models.fields.TextField')(null=True))

        # Changing field 'Question.symbol_vars'
        db.alter_column('questions_question', 'symbol_vars', self.gf('django.db.models.fields.CharField')(max_length=240, null=True))

    def backwards(self, orm):

        # Changing field 'AnswerChoice.explanation'
        db.alter_column('questions_answerchoice', 'explanation', self.gf('django.db.models.fields.CharField')(max_length=240, default=''))

        # Changing field 'Question.prompt'
        db.alter_column('questions_question', 'prompt', self.gf('django.db.models.fields.CharField')(max_length=240, default=''))

        # Changing field 'Question.code'
        db.alter_column('questions_question', 'code', self.gf('django.db.models.fields.TextField')(default=''))

        # Changing field 'Question.comment'
        db.alter_column('questions_question', 'comment', self.gf('django.db.models.fields.TextField')(default=''))

        # Changing field 'Question.symbol_vars'
        db.alter_column('questions_question', 'symbol_vars', self.gf('django.db.models.fields.CharField')(max_length=240, default=''))
