...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'AnswerChoice.explanation'
        db.delete_column('questions_answerchoice', 'explanation')

        # Deleting field 'AnswerChoice.correct'
        db.delete_column('questions_answerchoice', 'correct')

        # Adding field 'AnswerChoice.choice_type'
        db.add_column('questions_answerchoice', 'choice_type',
                      self.gf('django.db.models.fields.CharField')(max_length=20, default='DIST'),
                      keep_default=False)

        # Adding field 'AnswerChoice.comment'
        db.add_column('questions_answerchoice', 'comment',
                      self.gf('django.db.models.fields.CharField')(null=True, blank=True, max_length=240),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'AnswerChoice.explanation'
        db.add_column('questions_answerchoice', 'explanation',
                      self.gf('django.db.models.fields.CharField')(null=True, blank=True, max_length=240),
                      keep_default=False)

        # Adding field 'AnswerChoice.correct'
        db.add_column('questions_answerchoice', 'correct',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Deleting field 'AnswerChoice.choice_type'
        db.delete_column('questions_answerchoice', 'choice_type')

        # Deleting field 'AnswerChoice.comment'
        db.delete_column('questions_answerchoice', 'comment')
    ...
    models = {
        ...
        'questions.answerchoice': {
            ...
            'choice_type': ('django.db.models.fields.CharField', [], {'max_length': '20', 'default': "'DIST'"}),
            'comment': ('django.db.models.fields.CharField', [], {'null': 'True', 'blank': 'True', 'max_length': '240'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'questions.question': {
            ...
            'created_by': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'to': "orm['auth.User']"}),
            ...
            'prompt': ('django.db.models.fields.CharField', [], {'null': 'True', 'blank': 'True', 'max_length': '240'}),
            'symbol_vars': ('django.db.models.fields.CharField', [], {'null': 'True', 'blank': 'True', 'max_length': '240'})
        },
        'questions.randvar': {
